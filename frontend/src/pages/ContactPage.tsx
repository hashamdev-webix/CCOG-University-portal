...
import { FaEnvelope, FaPhone, FaMapMarkerAlt, FaClock, FaCheckCircle, FaGraduationCap } from "react-icons/fa";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden min-h-[50vh] flex items-center">
        ...
        />
        <div className="absolute inset-0 z-0" style={{ backgroundColor: "hsl(var(--primary) / 0.85)" }} />
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 text-white text-center">
          <div className="max-w-xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight leading-tight text-white">
              We're Here<br /><span className="text-yellow-300">to Help You</span>
            </h1>
      ...
      <section className="py-12 sm:py-16 bg-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {contactInfo.map((c) => (
              <div key={c.label} className="bg-background border border-border rounded-card shadow-soft p-5 text-center hover:shadow-lift transition-shadow">
      ...
      <section className="py-12 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
            ...
            {/* Form */}
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-2">Send a Message</h2>
              <p className="text-sm text-muted-foreground mb-7">Fill out the form and we'll get back to you shortly.</p>
              ...
              {submitted ? (
                <div className="bg-success/10 border border-success/30 rounded-card p-8 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">Thank you for reaching out. We'll reply within 24 hours.</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button type="submit"
                    className="w-full py-3 bg-primary text-primary-foreground rounded-input text-sm font-bold hover:opacity-90 transition-all">
                    Send Message
                  </button>
                </form>
              )}
            ...
            {/* Info Side */}
            <div>
              <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-2">Visit Our Campus</h2>
              <p className="text-sm text-muted-foreground mb-6">Come meet us in person at our main office.</p>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={d.label} className="flex justify-between items-center py-2.5 border-b border-border last:border-0">

...
export default function ArticlesPage() {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        const res = await api.get("/insights?type=article");
        setArticles(res.data.insights || []);
      } catch (error) {
      ...
      <section className="py-12 max-w-6xl mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2 max-w-2xl">
            ...
            from our faculty and research teams.
          </p>
        </div>
              ...
              >
                <div className="h-52 bg-muted">
                  <img
                    src={
                      item.featuredImage ||
                      "https://via.placeholder.com/800x500?text=Article+Image"
                    }
                    alt={item.title}

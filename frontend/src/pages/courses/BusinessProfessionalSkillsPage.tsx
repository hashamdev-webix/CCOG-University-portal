...
const BusinessProfessionalSkillsPage = () => {
  ...
  const getCourses = async () => {
    try {
      const { data } = await api.get(
        "/courses?category=business_professional_skills"
      );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <p className="text-muted-foreground text-sm sm:text-base leading-7">
              Explore practical courses designed to build business knowledge,
              workplace skills, and professional confidence.
            </p>
          </div>
...
export default BusinessProfessionalSkillsPage;